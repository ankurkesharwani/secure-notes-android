package com.ankur.securenotes.dao
...
object PasswordDao {
  ...
  fun createPassword(password: PasswordEntity, db: SQLiteDatabase): PasswordEntity? {
  ...
  fun updatePassword(password: PasswordEntity, db: SQLiteDatabase): PasswordEntity? {
    if (password.id == null) {
      return null
    }
